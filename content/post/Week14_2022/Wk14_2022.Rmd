---
title: "Week 14 2022 Recap"
author: "Samuel Kirschner"
date: "2022-12-11T13:09:13-06:00"
...
kfl_franchises_2021<-kfl_franchises_2021%>% mutate(logo = ifelse(franchise_id==12,"https://static.wikia.nocookie.net/metalgear/images/e/e7/Diamond_Dogs.svg",logo))
...
## Expected Wins power rankings through week 14 2022


```{r expected_wins, echo=FALSE,warning=FALSE,message=FALSE, error=TRUE,cache=TRUE}
...
img <- magick::image_read('C:/Users/cincy/OneDrive/Documents/Sam R Work/KFL_Analytics/content/post/Week14_2022/expected_wins-1.png')
plot(img)
...
```{r divison records, echo=FALSE,warning=FALSE,fig.width = 10,fig.height=8,message=FALSE,cache=TRUE}
