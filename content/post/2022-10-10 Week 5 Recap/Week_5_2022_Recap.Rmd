---
title: "Week 5 2022 Recap"
author: "Samuel Kirschner"
date: "2022-10-10T13:09:13-06:00"
...
Nick's "UN" Lucky Ducks are anything but and they should find their way to a casino shortly with the heater they are on. Not only do they get another win, but they win a tie-breaker off a miracle of a game by TE Travis Kelce. The Kraken put up another big win and keep pace right on the Duck's heels. Meanwhile, LGTE win a slugfest against the woefully unlucky Monarchs who seem destined to face 100+ point opponents week after week. The Bluecats got a win against the Titans to take the division lead. In a battle of the basement, the GMO's eked out a win against the Tenderloins.
...
wk4_matchups%>%mutate(win_prob=round(win_prob,2),opp_win_prob=round(opp_win_prob,2))%>%gt()%>%gt_img_rows(logo)%>%gt_img_rows(opponent_logo)%>%
  tab_header(title ="Week 5 2022 matchups")%>%
...
## Expected Wins power rankings through week 5 2022

 The Glum Division has our two juggernauts with a clear gap between LGTE and Onionhead's at the top of the expected wins table. The next tier has the Kraken, Slugs, and Monarchs who get the dubious honor of being our unluckiest team at -1.8 wins under expected. Two division leaders sit in the third tier with the "UN" Lucky ducks sitting at almost 3 wins over expected. All the way at the bottom of our expected wins rankings sit the Tenderloins who are still trying to rack up 1 expected win.
...
We continue to see the haves and have-nots in the KFL spread further apart. We have 6 1-4 teams who need to turn it around next week or pack the season in. Meanwhile Nick's "UN"Lucky Ducks now are the sole undefeated team at 5-0 after another win. The Onionhead's and LGTE share the lead in the Glum Division at 4-1 and the Bluecat's take sole possession of first at 4-1 as the Slugs dropped a heartbreaker to fall to 3-2.

One of these 4 win or better teams is going to miss the playoffs which will be a harsh beat this year given the lack of mediocrity in the league thus far.
...
### Best Ball Week 5 Update

Through 5 weeks the Bluecats are really squeezing the most juice out of their lineup with only 30 points under optimal. Their best ball record is the opposite of their actual record. The Slugs are not far behind having been the previous champ of minimizing poor lineup decision and then closely followed by the Onionheads.

On the other end, high flying teams like the LGTE and the "UN"Lucky Ducks have won despite leaving quite a few points on the bench. This just speaks to their bench depth and the makes both teams formidable as we head into the middle of the season.
...
The Bluecats get their first Stud of the Week thanks to a breakout game by Austin Ekeler. Ekeler had gone 4 straight games with no TDs and then found himself in the end zone 3 times to lead the Bluecats to the top of their division.
...
Dud of the week goes to MR. Welcome to Broncos Country, Danger Russ. Russell Wilson looks truly terrible making many in the analytics community question everything they thought they knew. Letting Russ cook is to risk burning down your kitchen. The only thing more disgraceful than Russ's performance this week is the trade that sent him to the GMO's and Josh Allen the other way. 
